...
const defaultSettings = {
    ...
    nameplateOpacity: .6,
    nameplateBorderSize: 1,  // multiplier for border thickness (0.01 – 5)
    nameplateSize: 1,        // overall scale for nameplate UI
...
const settingTypes = {
    ...
    nameplateOpacity: "number", nameplateBorderSize: "number",
...
function saveSettingsProfile(profileName) {
    if (profileName === "Default") return console.error("Cannot override default settings profile")
    let settingsInfo = getSavedSettings()
...
function deleteSettingsProfile(profileName) {
    if (profileName === "Default") return console.error("Cannot delete default settings profile")
    let settingsInfo = getSavedSettings()
    if (!settingsInfo.profiles[profileName]) return console.error(`Setting Profile ${profileName} does not exist`)
